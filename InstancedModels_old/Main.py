...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        default=0,
        choices=[0, 1],
        help="Enable Gurobi console logging (0=off, 1=on). Default: 0."
    )
    ...
    parser.add_argument(
        ...
        default=0,
        choices=[0, 1],
        help="Plot each best solution (0=no, 1=yes). Default: 0."
    )
    ...
    parser.add_argument(
        ...
        default=0,
        choices=[0, 1],
        help="Show object labels on plots. Default: 0."
    )
    ...
    parser.add_argument(
        ...
        default=0,
        choices=[0, 1],
        help="Show titles on plots. Default: 0."
    )
    ...
    parser.add_argument(
        ...
        default=1,
        choices=[0, 1],
        help="Use warm start heuristic. Default: 1."
    )
